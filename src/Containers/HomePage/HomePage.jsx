...
import PrimaryFeatureCategoryCarousel from "../../Components/FeatureCategoryCarousel/PrimaryFeatureCategoryCarousel";
import SecondaryFeatureCategoryCarousel from "../../Components/FeatureCategoryCarousel/SecondaryFeatureCategoryCarousel";
...
const HomePage = () => {
	...
	useEffect(() => {
		const checkCart = async () => {
			...
			console.log("found ", cartNum, "in cart");
